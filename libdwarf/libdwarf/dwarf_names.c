...
/* Generated on Jun  6 2015  19:46:21 */
...
dwarf_get_MACRO_name (unsigned int val,const char ** s_out)
{
    ...
    case DW_MACRO_define_indirect:
        *s_out = "DW_MACRO_define_indirect";
        return DW_DLV_OK;
    case DW_MACRO_undef_indirect:
        *s_out = "DW_MACRO_undef_indirect";
        return DW_DLV_OK;
    case DW_MACRO_transparent_include:
        *s_out = "DW_MACRO_transparent_include";
        return DW_DLV_OK;
    case DW_MACRO_define_indirect_sup:
        *s_out = "DW_MACRO_define_indirect_sup";
        return DW_DLV_OK;
    case DW_MACRO_undef_indirect_sup:
        *s_out = "DW_MACRO_undef_indirect_sup";
        return DW_DLV_OK;
    case DW_MACRO_transparent_include_sup:
        *s_out = "DW_MACRO_transparent_include_sup";
        return DW_DLV_OK;
    case DW_MACRO_define_indirectx:
        *s_out = "DW_MACRO_define_indirectx";
        return DW_DLV_OK;
    case DW_MACRO_undef_indirectx:
        *s_out = "DW_MACRO_undef_indirectx";
        return DW_DLV_OK;
