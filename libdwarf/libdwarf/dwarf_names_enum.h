...
enum Dwarf_MACRO_e {
    ...
    DW_MACRO_define_indirect                 = 0x0005,
    DW_MACRO_undef_indirect                  = 0x0006,
    DW_MACRO_transparent_include             = 0x0007,
    DW_MACRO_define_indirect_sup             = 0x0008,
    DW_MACRO_undef_indirect_sup              = 0x0009,
    DW_MACRO_transparent_include_sup         = 0x000a,
    DW_MACRO_define_indirectx                = 0x000b,
    DW_MACRO_undef_indirectx                 = 0x000c,
